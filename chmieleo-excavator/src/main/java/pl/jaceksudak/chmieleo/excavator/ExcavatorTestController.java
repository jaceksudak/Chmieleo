package pl.jaceksudak.chmieleo.excavator;
...
//                .build();
//
//        selector2.addAdditionalAction(additionalAction);    // TODO: coś tu się jebie
////        selector.removeAdditionalAction(additionalAction);
//
//
